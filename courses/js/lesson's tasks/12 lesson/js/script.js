var json_data = [{
    ...
    "name": "Sharlene Bush",
    "skills": [
        "interpersonal", "managing expectations", "organization", "prioritization", "active listening", "collaboration", "compromising"
    ],
    "gender": "female",
    "age": 34,
    ...
    "name": "Ross Vazquez",
    "skills": [
        "conflict resolution", "oral communication", "analytical skills", "troubleshooting", "technical documentation", "data analytics", "creativity"
    ],
    "gender": "male",
    "age": 24,
    ...
    "name": "Elma Head",
    "skills": [
        "critical thinking", "strong analytical ", "problem-solving ", "strong communication"
    ],
    "gender": "female",
    "age": 21,
    ...
    "name": "Carey Barr",
    "skills": [
        "organization", "prioritization", "active listening"
    ],
    "gender": "male",
    "age": 27,
    ...
    "skills": [
        "technical documentation", "data analytics", "creativity"
    ],
    "gender": "male",
    "age": 38,
    ...
    "name": "Sheree Anthony",
    "skills": [
        "database architecture", "product enhancement", "problem solving", "perl"
    ],
    "gender": "female",
    "age": 39,
...
//№1 Массив скиллов (поле skills) всех людей без повторения скиллов и в алфавитном порядке
...
let names = _.map(_.sortBy(json_data, "friends"), "name");
console.log(names)